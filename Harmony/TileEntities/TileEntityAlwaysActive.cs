...
namespace Harmony.TileEntities
{
    ...
    public class TileEntityAlwaysActive
    {
        ...
        {
            public static bool Prefix(TileEntity __instance, ref bool __result)
            {
                ...
                if (StringParsers.ParseBool(__instance.blockValue.Block.Properties.Values["AlwaysActive"]))
                {
                    __result = true;
                    return false;
                }
